...
kData          equ &9000         ;Typically &FC00 (to &FFFF)
kStrBuffer     equ kData+&0180   ;String buffer              (to +&01FF)
...
_ConTest:   AND   (HL)          ;Mask required flag bit (clears Cy)
            POP  HL
...
DisConTab:  defb  &40           ;xZxxxxxx   NZ,        Z=0,  Not Zero
            defb  &01           ;xxxxxxxC   NC,        C=0,  No Carry
            defb  &04           ;xxxxxxxC   PO,        P=0,  Parity Odd
            defb  &80           ;xxxxxxxC   PO,        S=0,  Positive
...
iDisIndex:  defb  &00           ;Index instruction opcode
iDisOpStr:  defb  &00           ;Operation string number
iDisOp1Str: defb  &00           ;Operand 1 string number
iDisOpcode: defb  &00           ;Primary instruction opcode
iDisImmed:  defw  &0000         ;Immediate value
