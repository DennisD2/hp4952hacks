...
DisOperandTable:
            defb  0x00,0x00      ;0b000000 ;Operand  1 = ""
            defb  0x00,0x10      ;0b010000 ;Operand  2 = "n"
            defb  0x00,0x30      ;0b110000 ;Operand  3 = "(n)"
            defb  0x00,0x18      ;0b011000 ;Operand  4 = "nn"
            defb  0x00,0x38      ;0b111000 ;Operand  5 = "(nn)"
            defb  0x0E,0x03      ;0b000011 ;Operand  6 = "r"
            defb  0x0E,0x00      ;0b000000 ;Operand  7 = "r2"
            defb  0x0F,0x06      ;0b000110 ;Operand  8 = "dd"
            defb  0x10,0x06      ;0b000110 ;Operand  9 = "qq"
            defb  0x11,0x05      ;0b000101 ;Operand 10 = "c"
            defb  0x12,0x07      ;0b000111 ;Operand 11 = "cc"
            defb  0x13,0x07      ;0b000111 ;Operand 12 = "t"
            defb  0x14,0x03      ;0b000011 ;Operand 13 = "b"
...
DisMaskTable:
            defb  0x07           ;Mask type 0
            defb  0x18           ;Mask type 1
            defb  0x30           ;Mask type 2
            defb  0x38           ;Mask type 3
...
DisConTab:  defb  0x40           ;xZxxxxxx   NZ,        Z=0,  Not Zero
            defb  0x01           ;xxxxxxxC   NC,        C=0,  No Carry
            defb  0x04           ;xxxxxxxC   PO,        P=0,  Parity Odd
            defb  0x80           ;xxxxxxxC   PO,        S=0,  Positive
...
iDisIndex:  defb  0x00           ;Index instruction opcode
iDisOpStr:  defb  0x00           ;Operation string number
iDisOp1Str: defb  0x00           ;Operand 1 string number
iDisOpcode: defb  0x00           ;Primary instruction opcode
iDisImmed:  defw  0x0000         ;Immediate value
