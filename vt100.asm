; z80dasm 1.1.6
; command line: z80dasm -t -a -g 0xa000 -o vt100.dasm VT100.no_header
	...
	ld sp,03332h		;a7a3	31 32 33 	1 2 3 
	inc (hl)			;a7a6	34 	4 
	dec (hl)			;a7a7	35 	5 
	ld (hl),037h		;a7a8	36 37 	6 7 
	jr c,$+59		;a7aa	38 39 	8 9 
	ld a,(02c3bh)		;a7ac	3a 3b 2c 	: ; , 
	dec l			;a7af	2d 	- 
	ld l,02fh		;a7b0	2e 2f 	. / 
	ld h,b			;a7b2	60 	` 
	ld h,c			;a7b3	61 	a 
	ld h,d			;a7b4	62 	b 
	ld h,e			;a7b5	63 	c 
	...
	ld hl,02322h		;a7e3	21 22 23 	! " # 
	inc h			;a7e6	24 	$ 
	dec h			;a7e7	25 	% 
	ld h,027h		;a7e8	26 27 	& ' 
	jr z,$+43		;a7ea	28 29 	( ) 
	ld hl,(03c2bh)		;a7ec	2a 2b 3c 	* + < 
	dec a			;a7ef	3d 	= 
	ld a,03fh		;a7f0	3e 3f 	> ? 
	ld b,b			;a7f2	40 	@ 
	ld b,c			;a7f3	41 	A 
	ld b,d			;a7f4	42 	B 
	ld b,e			;a7f5	43 	C 
	...
	ld d,(hl)			;c004	56 	V 
	ld d,h			;c005	54 	T 
	ld sp,03030h		;c006	31 30 30 	1 0 0 
	jr nz,$+34		;c009	20 20 	    
	ld b,l			;c00b	45 	E 
	ld l,l			;c00c	6d 	m 
	ld (hl),l			;c00d	75 	u 
	...
	ld h,l			;c018	65 	e 
	halt			;c019	76 	v 
	jr nz,$+67		;c01a	20 41 	  A 
	ld l,030h		;c01c	2e 30 	. 0 
	jr nc,$+48		;c01e	30 2e 	0 . 
	jr nc,$+53		;c020	30 33 	0 3 
	nop			;c022	00 	. 
	rlca			;c023	07 	. 
	add hl,bc			;c024	09 	. 
	add a,e			;c025	83 	. 
	xor e			;c026	ab 	. 
	jr nz,$+69		;c027	20 43 	  C 
	ld l,a			;c029	6f 	o 
	ld (hl),b			;c02a	70 	p 
	ld a,c			;c02b	79 	y 
	ld (hl),d			;c02c	72 	r 
	...
	ld l,b			;c02f	68 	h 
	ld (hl),h			;c030	74 	t 
	jr nz,$+51		;c031	20 31 	  1 
	add hl,sp			;c033	39 	9 
	jr c,$+59		;c034	38 39 	8 9 
	nop			;c036	00 	. 
	ex af,af'			;c037	08 	. 
	dec b			;c038	05 	. 
	add a,e			;c039	83 	. 
	...
	ld l,a			;c056	6f 	o 
	ld (hl),d			;c057	72 	r 
	jr nz,$+118		;c058	20 74 	  t 
	ld l,b			;c05a	68 	h 
	ld h,l			;c05b	65 	e 
	jr nz,$+74		;c05c	20 48 	  H 
	ld d,b			;c05e	50 	P 
	jr nz,$+54		;c05f	20 34 	  4 
	add hl,sp			;c061	39 	9 
	dec (hl)			;c062	35 	5 
	...
	ld l,a			;c1bc	6f 	o 
	ld (hl),d			;c1bd	72 	r 
	jr nz,$+79		;c1be	20 4d 	  M 
	ld h,l			;c1c0	65 	e 
	ld l,(hl)			;c1c1	6e 	n 
	ld (hl),l			;c1c2	75 	u 
	nop			;c1c3	00 	. 
	inc bc			;c1c4	03 	. 
	ld bc,053abh		;c1c5	01 ab 53 	. . S 
	ld h,l			;c1c8	65 	e 
	ld (hl),h			;c1c9	74 	t 
	ld (hl),l			;c1ca	75 	u 
	ld (hl),b			;c1cb	70 	p 
	jr nz,$+79		;c1cc	20 4d 	  M 
	ld h,l			;c1ce	65 	e 
	ld l,(hl)			;c1cf	6e 	n 
	ld (hl),l			;c1d0	75 	u 
	nop			;c1d1	00 	. 
	...
	ld (hl),d			;c1f2	72 	r 
	ld (hl),e			;c1f3	73 	s 
	jr nz,$+104		;c1f4	20 66 	  f 
	ld l,a			;c1f6	6f 	o 
	ld (hl),d			;c1f7	72 	r 
	jr nz,$+118		;c1f8	20 74 	  t 
	ld h,l			;c1fa	65 	e 
	ld (hl),d			;c1fb	72 	r 
	ld l,l			;c1fc	6d 	m 
	ld l,c			;c1fd	69 	i 
	...
	ld h,c			;c1ff	61 	a 
	ld l,h			;c200	6c 	l 
	ld l,000h		;c201	2e 00 	. . 
	dec b			;c203	05 	. 
	ld bc,053abh		;c204	01 ab 53 	. . S 
	ld h,l			;c207	65 	e 
	ld (hl),h			;c208	74 	t 
	ld (hl),l			;c209	75 	u 
	ld (hl),b			;c20a	70 	p 
	...
	ld (hl),h			;c232	74 	t 
	ld h,l			;c233	65 	e 
	jr nz,$+117		;c234	20 73 	  s 
	ld h,l			;c236	65 	e 
	ld (hl),h			;c237	74 	t 
	ld (hl),l			;c238	75 	u 
	ld (hl),b			;c239	70 	p 
	jr nz,$+118		;c23a	20 74 	  t 
	ld l,a			;c23c	6f 	o 
	jr nz,$+118		;c23d	20 74 	  t 
	ld h,l			;c23f	65 	e 
	ld (hl),d			;c240	72 	r 
	ld l,l			;c241	6d 	m 
	ld l,c			;c242	69 	i 
	...
	ld h,c			;c244	61 	a 
	ld l,h			;c245	6c 	l 
	ld l,000h		;c246	2e 00 	. . 
	rlca			;c248	07 	. 
	ld bc,053abh		;c249	01 ab 53 	. . S 
	ld l,c			;c24c	69 	i 
	ld l,l			;c24d	6d 	m 
	ld (hl),l			;c24e	75 	u 
	ld l,h			;c24f	6c 	l 
	...
	ld l,(hl)			;c27b	6e 	n 
	ld h,a			;c27c	67 	g 
	jr nz,$+110		;c27d	20 6c 	  l 
	ld h,l			;c27f	65 	e 
	ld h,c			;c280	61 	a 
	ld h,h			;c281	64 	d 
	ld (hl),e			;c282	73 	s 
	jr nz,$+119		;c283	20 75 	  u 
	ld (hl),b			;c285	70 	p 
	ld l,000h		;c286	2e 00 	. . 
	add hl,bc			;c288	09 	. 
	ld bc,045abh		;c289	01 ab 45 	. . E 
	ld a,b			;c28c	78 	x 
	ld h,l			;c28d	65 	e 
	ld h,e			;c28e	63 	c 
	ld (hl),l			;c28f	75 	u 
	...
	ld h,c			;c2a2	61 	a 
	ld l,h			;c2a3	6c 	l 
	jr nz,$+111		;c2a4	20 6d 	  m 
	ld l,a			;c2a6	6f 	o 
	ld h,h			;c2a7	64 	d 
	ld h,l			;c2a8	65 	e 
	ld l,000h		;c2a9	2e 00 	. . 
	nop			;c2ab	00 	. 
	cp h			;c2ac	bc 	. 
	inc l			;c2ad	2c 	, 
	...
	ld (hl),l			;c2c9	75 	u 
	ld (hl),b			;c2ca	70 	p 
	ld hl,05321h		;c2cb	21 21 53 	! ! S 
	ld l,c			;c2ce	69 	i 
	ld l,l			;c2cf	6d 	m 
	ld (hl),l			;c2d0	75 	u 
	dec l			;c2d1	2d 	- 
	ld hl,02020h		;c2d2	21 20 20 	!     
	jr nz,$+34		;c2d5	20 20 	    
	ld hl,07845h		;c2d7	21 45 78 	! E x 
	ld h,l			;c2da	65 	e 
	dec l			;c2db	2d 	- 
	jr nz,$+79		;c2dc	20 4d 	  M 
	ld h,l			;c2de	65 	e 
	ld l,(hl)			;c2df	6e 	n 
	ld (hl),l			;c2e0	75 	u 
	ld hl,02020h		;c2e1	21 20 20 	!     
	jr nz,$+35		;c2e4	20 21 	  ! 
	dec a			;c2e6	3d 	= 
	ld d,e			;c2e7	53 	S 
	ld l,c			;c2e8	69 	i 
	ld l,l			;c2e9	6d 	m 
	ld l,021h		;c2ea	2e 21 	. ! 
	ld hl,06c20h		;c2ec	21 20 6c 	!   l 
	ld h,c			;c2ef	61 	a 
	ld (hl),h			;c2f0	74 	t 
	ld h,l			;c2f1	65 	e 
	ld hl,02020h		;c2f2	21 20 20 	!     
	jr nz,$+34		;c2f5	20 20 	    
	ld hl,07563h		;c2f7	21 63 75 	! c u 
	ld (hl),h			;c2fa	74 	t 
	ld h,l			;c2fb	65 	e 
	...
	ld h,c			;c36e	61 	a 
	ld l,h			;c36f	6c 	l 
	jr nz,$+85		;c370	20 53 	  S 
	ld h,l			;c372	65 	e 
	ld (hl),h			;c373	74 	t 
	ld (hl),l			;c374	75 	u 
	ld (hl),b			;c375	70 	p 
	jr nz,$+79		;c376	20 4d 	  M 
	ld h,l			;c378	65 	e 
	ld l,(hl)			;c379	6e 	n 
	ld (hl),l			;c37a	75 	u 
	nop			;c37b	00 	. 
	inc bc			;c37c	03 	. 
	ld bc,04483h		;c37d	01 83 44 	. . D 
	ld h,c			;c380	61 	a 
	ld (hl),h			;c381	74 	t 
	ld h,c			;c382	61 	a 
	jr nz,$+69		;c383	20 43 	  C 
	ld l,a			;c385	6f 	o 
	ld h,h			;c386	64 	d 
	ld h,l			;c387	65 	e 
	nop			;c388	00 	. 
	inc b			;c389	04 	. 
	ld bc,05083h		;c38a	01 83 50 	. . P 
	ld h,c			;c38d	61 	a 
	ld (hl),d			;c38e	72 	r 
	ld l,c			;c38f	69 	i 
	ld (hl),h			;c390	74 	t 
	...
	nop			;c3b3	00 	. 
	ld a,(bc)			;c3b4	0a 	. 
	ld bc,04583h		;c3b5	01 83 45 	. . E 
	ld h,e			;c3b8	63 	c 
	ld l,b			;c3b9	68 	h 
	ld l,a			;c3ba	6f 	o 
	nop			;c3bb	00 	. 
	dec bc			;c3bc	0b 	. 
	ld bc,04283h		;c3bd	01 83 42 	. . B 
	ld h,l			;c3c0	65 	e 
	ld l,h			;c3c1	6c 	l 
	ld l,h			;c3c2	6c 	l 
	nop			;c3c3	00 	. 
	inc c			;c3c4	0c 	. 
	ld bc,04483h		;c3c5	01 83 44 	. . D 
	ld l,c			;c3c8	69 	i 
	ld (hl),e			;c3c9	73 	s 
	ld (hl),b			;c3ca	70 	p 
	ld l,h			;c3cb	6c 	l 
	...
	nop			;c3d8	00 	. 
	dec c			;c3d9	0d 	. 
	ld bc,04183h		;c3da	01 83 41 	. . A 
	ld (hl),l			;c3dd	75 	u 
	ld (hl),h			;c3de	74 	t 
	ld l,a			;c3df	6f 	o 
	jr nz,$+78		;c3e0	20 4c 	  L 
	ld b,(hl)			;c3e2	46 	F 
	jr nz,$+99		;c3e3	20 61 	  a 
	ld h,(hl)			;c3e5	66 	f 
	ld (hl),h			;c3e6	74 	t 
	ld h,l			;c3e7	65 	e 
	ld (hl),d			;c3e8	72 	r 
	jr nz,$+69		;c3e9	20 43 	  C 
	ld d,d			;c3eb	52 	R 
	nop			;c3ec	00 	. 
	nop			;c3ed	00 	. 
	inc bc			;c3ee	03 	. 
	...
	nop			;c47b	00 	. 
	ld l,(hl)			;c47c	6e 	n 
	ld l,041h		;c47d	2e 41 	. A 
	ld d,e			;c47f	53 	S 
	ld b,e			;c480	43 	C 
	ld c,c			;c481	49 	I 
	ld c,c			;c482	49 	I 
	ld hl,05341h		;c483	21 41 53 	! A S 
	ld b,e			;c486	43 	C 
	ld c,c			;c487	49 	I 
	ld c,c			;c488	49 	I 
	ld hl,02020h		;c489	21 20 20 	!     
	jr nz,$+34		;c48c	20 20 	    
	ld hl,02021h		;c48e	21 21 20 	! !   
	jr nz,$+34		;c491	20 20 	    
	jr nz,$+35		;c493	20 21 	  ! 
	jr nz,$+34		;c495	20 20 	    
	jr nz,$+34		;c497	20 20 	    
	ld hl,02020h		;c499	21 20 20 	!     
	jr nz,$+34		;c49c	20 20 	    
	jr nz,$+34		;c49e	20 20 	    
	jr c,$+34		;c4a0	38 20 	8   
	jr nz,$+35		;c4a2	20 21 	  ! 
	jr nz,$+34		;c4a4	20 20 	    
	scf			;c4a6	37 	7 
	jr nz,$+34		;c4a7	20 20 	    
	ld hl,02020h		;c4a9	21 20 20 	!     
	jr nz,$+34		;c4ac	20 20 	    
	ld hl,02021h		;c4ae	21 21 20 	! !   
	jr nz,$+34		;c4b1	20 20 	    
	jr nz,$+35		;c4b3	20 21 	  ! 
	jr nz,$+34		;c4b5	20 20 	    
	jr nz,$+34		;c4b7	20 20 	    
	ld hl,02020h		;c4b9	21 20 20 	!     
	jr nz,$+34		;c4bc	20 20 	    
	ld h,b			;c4be	60 	` 
	rst 38h			;c4bf	ff 	. 
	...
	ld l,(hl)			;c4f0	6e 	n 
	ld h,l			;c4f1	65 	e 
	ld hl,0644fh		;c4f2	21 4f 64 	! O d 
	ld h,h			;c4f5	64 	d 
	ld hl,07645h		;c4f6	21 45 76 	! E v 
	ld h,l			;c4f9	65 	e 
	ld l,(hl)			;c4fa	6e 	n 
	ld hl,05321h		;c4fb	21 21 53 	! ! S 
	ld (hl),b			;c4fe	70 	p 
	ld h,c			;c4ff	61 	a 
	ld h,e			;c500	63 	c 
	ld h,l			;c501	65 	e 
	ld hl,0614dh		;c502	21 4d 61 	! M a 
	ld (hl),d			;c505	72 	r 
	ld l,e			;c506	6b 	k 
	ld hl,06749h		;c507	21 49 67 	! I g 
	ld l,(hl)			;c50a	6e 	n 
	ld l,a			;c50b	6f 	o 
	ld (hl),d			;c50c	72 	r 
	ld h,l			;c50d	65 	e 
	jr nz,$+34		;c50e	20 20 	    
	jr nz,$+34		;c510	20 20 	    
	ld hl,02020h		;c512	21 20 20 	!     
	jr nz,$+35		;c515	20 21 	  ! 
	jr nz,$+34		;c517	20 20 	    
	jr nz,$+34		;c519	20 20 	    
	ld hl,02021h		;c51b	21 21 20 	! !   
	jr z,$+67		;c51e	28 41 	( A 
	ld d,e			;c520	53 	S 
	ld b,e			;c521	43 	C 
	ld c,c			;c522	49 	I 
	ld c,c			;c523	49 	I 
	...
	jr nc,$+53		;c597	30 33 	0 3 
	jr nc,$+50		;c599	30 30 	0 0 
	jr nz,$+35		;c59b	20 21 	  ! 
	ld sp,03032h		;c59d	31 32 30 	1 2 0 
	jr nc,$+35		;c5a0	30 21 	0 ! 
	ld (03034h),a		;c5a2	32 34 30 	2 4 0 
	jr nc,$+35		;c5a5	30 21 	0 ! 
	ld hl,03834h		;c5a7	21 34 38 	! 4 8 
	jr nc,$+50		;c5aa	30 30 	0 0 
	ld hl,03639h		;c5ac	21 39 36 	! 9 6 
	jr nc,$+50		;c5af	30 30 	0 0 
	ld hl,03931h		;c5b1	21 31 39 	! 1 9 
	ld (03030h),a		;c5b4	32 30 30 	2 0 0 
	ld a,(hl)			;c5b7	7e 	~ 
	jr nz,$+34		;c5b8	20 20 	    
	jr nz,$+34		;c5ba	20 20 	    
	ld hl,02020h		;c5bc	21 20 20 	!     
	jr nz,$+34		;c5bf	20 20 	    
	ld hl,02020h		;c5c1	21 20 20 	!     
	jr nz,$+34		;c5c4	20 20 	    
	ld hl,02021h		;c5c6	21 21 20 	! !   
	jr nz,$+34		;c5c9	20 20 	    
	jr nz,$+35		;c5cb	20 21 	  ! 
	jr nz,$+34		;c5cd	20 20 	    
	jr nz,$+34		;c5cf	20 20 	    
	ld hl,02020h		;c5d1	21 20 20 	!     
	jr nz,$+34		;c5d4	20 20 	    
	...
	nop			;c5ec	00 	. 
	nop			;c5ed	00 	. 
	ld sp,03032h		;c5ee	31 32 30 	1 2 0 
	jr nc,$+34		;c5f1	30 20 	0   
	nop			;c5f3	00 	. 
	rst 38h			;c5f4	ff 	. 
	ld (bc),a			;c5f5	02 	. 
	...
	nop			;c5fa	00 	. 
	nop			;c5fb	00 	. 
	ld (03034h),a		;c5fc	32 34 30 	2 4 0 
	jr nc,$+34		;c5ff	30 20 	0   
	nop			;c601	00 	. 
	ld a,a			;c602	7f 	 
	...
	nop			;c609	00 	. 
	inc (hl)			;c60a	34 	4 
	jr c,$+50		;c60b	38 30 	8 0 
	jr nc,$+34		;c60d	30 20 	0   
	nop			;c60f	00 	. 
	cp a			;c610	bf 	. 
	nop			;c611	00 	. 
	jr $+50		;c612	18 30 	. 0 
	...
	nop			;c617	00 	. 
	add hl,sp			;c618	39 	9 
	ld (hl),030h		;c619	36 30 	6 0 
	jr nc,$+34		;c61b	30 20 	0   
	nop			;c61d	00 	. 
	ld e,a			;c61e	5f 	_ 
	nop			;c61f	00 	. 
	...
	nop			;c624	00 	. 
	nop			;c625	00 	. 
	ld sp,03239h		;c626	31 39 32 	1 9 2 
	jr nc,$+50		;c629	30 30 	0 0 
	nop			;c62b	00 	. 
	inc a			;c62c	3c 	< 
	...
	ld hl,03032h		;c641	21 32 30 	! 2 0 
	jr nc,$+35		;c644	30 21 	0 ! 
	ld (hl),030h		;c646	36 30 	6 0 
	jr nc,$+35		;c648	30 21 	0 ! 
	ld hl,03121h		;c64a	21 21 31 	! ! 1 
	jr c,$+50		;c64d	38 30 	8 0 
	jr nc,$+35		;c64f	30 21 	0 ! 
	ld hl,03233h		;c651	21 33 32 	! 3 2 
	jr nc,$+50		;c654	30 30 	0 0 
	ld hl,03633h		;c656	21 33 36 	! 3 6 
	jr nc,$+50		;c659	30 30 	0 0 
	ld a,(hl)			;c65b	7e 	~ 
	jr nz,$+34		;c65c	20 20 	    
	jr nz,$+34		;c65e	20 20 	    
	jr nz,$+35		;c660	20 21 	  ! 
	...
	jr nz,$+34		;c666	20 20 	    
	jr nz,$+35		;c668	20 21 	  ! 
	ld hl,02021h		;c66a	21 21 20 	! !   
	jr nz,$+34		;c66d	20 20 	    
	jr nz,$+35		;c66f	20 21 	  ! 
	ld hl,02020h		;c671	21 20 20 	!     
	jr nz,$+34		;c674	20 20 	    
	ld hl,02020h		;c676	21 20 20 	!     
	jr nz,$+34		;c679	20 20 	    
	ld a,h			;c67b	7c 	| 
	cpl			;c67c	2f 	/ 
	nop			;c67d	00 	. 
	...
	nop			;c683	00 	. 
	inc sp			;c684	33 	3 
	jr c,$+54		;c685	38 34 	8 4 
	jr nc,$+50		;c687	30 30 	0 0 
	nop			;c689	00 	. 
	ld (hl),e			;c68a	73 	s 
	ld b,c			;c68b	41 	A 
	sub d			;c68c	92 	. 
	...
	nop			;c690	00 	. 
	nop			;c691	00 	. 
	ld sp,03031h		;c692	31 31 30 	1 1 0 
	jr nz,$+34		;c695	20 20 	    
	nop			;c697	00 	. 
	rst 38h			;c698	ff 	. 
	inc hl			;c699	23 	# 
	...
	nop			;c69e	00 	. 
	nop			;c69f	00 	. 
	ld (03030h),a		;c6a0	32 30 30 	2 0 0 
	jr nz,$+34		;c6a3	20 20 	    
	nop			;c6a5	00 	. 
	rst 38h			;c6a6	ff 	. 
	dec bc			;c6a7	0b 	. 
	...
	nop			;c6ac	00 	. 
	nop			;c6ad	00 	. 
	ld (hl),030h		;c6ae	36 30 	6 0 
	jr nc,$+34		;c6b0	30 20 	0   
	jr nz,$+2		;c6b2	20 00 	  . 
	rst 38h			;c6b4	ff 	. 
	inc bc			;c6b5	03 	. 
	cp h			;c6b6	bc 	. 
	...
	nop			;c6ba	00 	. 
	nop			;c6bb	00 	. 
	ld sp,03038h		;c6bc	31 38 30 	1 8 0 
	jr nc,$+34		;c6bf	30 20 	0   
	nop			;c6c1	00 	. 
	ccf			;c6c2	3f 	? 
	ld (bc),a			;c6c3	02 	. 
	...
	nop			;c6c9	00 	. 
	inc sp			;c6ca	33 	3 
	ld (03030h),a		;c6cb	32 30 30 	2 0 0 
	jr nz,$+2		;c6ce	20 00 	  . 
	rst 38h			;c6d0	ff 	. 
	...
	nop			;c6d7	00 	. 
	inc sp			;c6d8	33 	3 
	ld (hl),030h		;c6d9	36 30 	6 0 
	jr nc,$+34		;c6db	30 20 	0   
	nop			;c6dd	00 	. 
	...
	ld sp,03031h		;c6ee	31 31 30 	1 1 0 
	jr nz,$+35		;c6f1	20 21 	  ! 
	jr nz,$+57		;c6f3	20 37 	  7 
	dec (hl)			;c6f5	35 	5 
	jr nz,$+35		;c6f6	20 21 	  ! 
	jr nz,$+52		;c6f8	20 32 	  2 
	jr nc,$+50		;c6fa	30 30 	0 0 
	jr nc,$+35		;c6fc	30 21 	0 ! 
	ld hl,03331h		;c6fe	21 31 33 	! 1 3 
	inc (hl)			;c701	34 	4 
	ld l,035h		;c702	2e 35 	. 5 
	ld hl,03531h		;c704	21 31 35 	! 1 5 
	jr nc,$+35		;c707	30 21 	0 ! 
	scf			;c709	37 	7 
	ld (03030h),a		;c70a	32 30 30 	2 0 0 
	ld a,(hl)			;c70d	7e 	~ 
	jr nz,$+34		;c70e	20 20 	    
	jr nz,$+34		;c710	20 20 	    
	ld hl,02020h		;c712	21 20 20 	!     
	jr nz,$+34		;c715	20 20 	    
	ld hl,02020h		;c717	21 20 20 	!     
	jr nz,$+34		;c71a	20 20 	    
	jr nz,$+35		;c71c	20 21 	  ! 
	ld hl,02020h		;c71e	21 20 20 	!     
	jr nz,$+34		;c721	20 20 	    
	jr nz,$+35		;c723	20 21 	  ! 
	jr nz,$+34		;c725	20 20 	    
	jr nz,$+35		;c727	20 21 	  ! 
	...
	nop			;c742	00 	. 
	nop			;c743	00 	. 
	ld (03030h),a		;c744	32 30 30 	2 0 0 
	jr nc,$+34		;c747	30 20 	0   
	nop			;c749	00 	. 
	add a,a			;c74a	87 	. 
	dec (hl)			;c74b	35 	5 
	ld d,d			;c74c	52 	R 
	...
	nop			;c750	00 	. 
	nop			;c751	00 	. 
	ld sp,03433h		;c752	31 33 34 	1 3 4 
	ld l,035h		;c755	2e 35 	. 5 
	nop			;c757	00 	. 
	rst 38h			;c758	ff 	. 
	cpl			;c759	2f 	/ 
	ld h,b			;c75a	60 	` 
	...
	nop			;c75e	00 	. 
	nop			;c75f	00 	. 
	ld sp,03035h		;c760	31 35 30 	1 5 0 
	jr nz,$+34		;c763	20 20 	    
	nop			;c765	00 	. 
	rst 38h			;c766	ff 	. 
	nop			;c767	00 	. 
	...
	nop			;c76d	00 	. 
	scf			;c76e	37 	7 
	ld (03030h),a		;c76f	32 30 30 	2 0 0 
	jr nz,$+2		;c772	20 00 	  . 
	add a,h			;c774	84 	. 
	...
	nop			;c781	00 	. 
	ld (hl),h			;c782	74 	t 
	ld sp,06f4eh		;c783	31 4e 6f 	1 N o 
	ld l,(hl)			;c786	6e 	n 
	ld h,l			;c787	65 	e 
	ld hl,06e45h		;c788	21 45 6e 	! E n 
	ld (hl),c			;c78b	71 	q 
	cpl			;c78c	2f 	/ 
	ld hl,02020h		;c78d	21 20 20 	!     
	jr nz,$+34		;c790	20 20 	    
	jr nz,$+35		;c792	20 21 	  ! 
	ld hl,02020h		;c794	21 20 20 	!     
	jr nz,$+34		;c797	20 20 	    
	ld hl,02020h		;c799	21 20 20 	!     
	jr nz,$+34		;c79c	20 20 	    
	jr nz,$+35		;c79e	20 21 	  ! 
	jr nz,$+34		;c7a0	20 20 	    
	jr nz,$+34		;c7a2	20 20 	    
	jr nz,$+34		;c7a4	20 20 	    
	jr nz,$+34		;c7a6	20 20 	    
	ld hl,04120h		;c7a8	21 20 41 	!   A 
	ld h,e			;c7ab	63 	c 
	ld l,e			;c7ac	6b 	k 
	ld hl,02020h		;c7ad	21 20 20 	!     
	jr nz,$+34		;c7b0	20 20 	    
	jr nz,$+35		;c7b2	20 21 	  ! 
	ld hl,02020h		;c7b4	21 20 20 	!     
	jr nz,$+34		;c7b7	20 20 	    
	ld hl,02020h		;c7b9	21 20 20 	!     
	jr nz,$+34		;c7bc	20 20 	    
	jr nz,$+35		;c7be	20 21 	  ! 
	jr nz,$+34		;c7c0	20 20 	    
	jr nz,$+34		;c7c2	20 20 	    
	...
	ld b,l			;c7f7	45 	E 
	jr nz,$+35		;c7f8	20 21 	  ! 
	jr nz,$+70		;c7fa	20 44 	  D 
	ld b,e			;c7fc	43 	C 
	ld b,l			;c7fd	45 	E 
	jr nz,$+35		;c7fe	20 21 	  ! 
	jr nz,$+34		;c800	20 20 	    
	jr nz,$+34		;c802	20 20 	    
	ld hl,02021h		;c804	21 21 20 	! !   
	jr nz,$+34		;c807	20 20 	    
	jr nz,$+35		;c809	20 21 	  ! 
	jr nz,$+34		;c80b	20 20 	    
	jr nz,$+34		;c80d	20 20 	    
	ld hl,02020h		;c80f	21 20 20 	!     
	jr nz,$+34		;c812	20 20 	    
	jr nz,$+34		;c814	20 20 	    
	jr nz,$+34		;c816	20 20 	    
	jr nz,$+35		;c818	20 21 	  ! 
	...
	jr nz,$+34		;c820	20 20 	    
	jr nz,$+34		;c822	20 20 	    
	ld hl,02021h		;c824	21 21 20 	! !   
	jr nz,$+34		;c827	20 20 	    
	jr nz,$+35		;c829	20 21 	  ! 
	jr nz,$+34		;c82b	20 20 	    
	jr nz,$+34		;c82d	20 20 	    
	ld hl,02020h		;c82f	21 20 20 	!     
	jr nz,$+34		;c832	20 20 	    
	add a,c			;c834	81 	. 
	nop			;c835	00 	. 
	inc a			;c836	3c 	< 
	...
	ld l,(hl)			;c87e	6e 	n 
	jr nz,$+35		;c87f	20 21 	  ! 
	jr nz,$+81		;c881	20 4f 	  O 
	ld h,(hl)			;c883	66 	f 
	ld h,(hl)			;c884	66 	f 
	jr nz,$+35		;c885	20 21 	  ! 
	jr nz,$+34		;c887	20 20 	    
	jr nz,$+34		;c889	20 20 	    
	ld hl,02021h		;c88b	21 21 20 	! !   
	jr nz,$+34		;c88e	20 20 	    
	jr nz,$+35		;c890	20 21 	  ! 
	jr nz,$+34		;c892	20 20 	    
	jr nz,$+34		;c894	20 20 	    
	...
	jr nz,$+34		;c89c	20 20 	    
	jr nz,$+34		;c89e	20 20 	    
	ld hl,02020h		;c8a0	21 20 20 	!     
	jr nz,$+34		;c8a3	20 20 	    
	jr nz,$+35		;c8a5	20 21 	  ! 
	jr nz,$+34		;c8a7	20 20 	    
	jr nz,$+34		;c8a9	20 20 	    
	ld hl,02021h		;c8ab	21 21 20 	! !   
	jr nz,$+34		;c8ae	20 20 	    
	jr nz,$+35		;c8b0	20 21 	  ! 
	jr nz,$+34		;c8b2	20 20 	    
	jr nz,$+34		;c8b4	20 20 	    
