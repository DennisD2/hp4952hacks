...
kData:          EQU 0x8000         ;Typically 0xFC00 (to 0xFFFF) TODO: good value
kStrBuffer:     EQU kData+0x0180   ;String buffer              (to +0x01FF)
kStrSize:       EQU 128            ;Size of string buffer

iHL:        defw  0x0005         ;Register pair HL
iAF:        defw  0x0002         ;Register pair AF
iBC:        defw  0x0003         ;Register pair BC
iSP:        defw  0x0011         ;Register pair SP (Stack Pointer)

iStrStart:  defw  0x0000         ;Start of current string buffer
iStrSize:   defw  0x00           ;Size of current string buffer (0 to Len-1)
...
_S_Skip:      ADD  A,0x30         ;Add ASCII '0'
...
StrWrPadding:
            ...
            JR   Z,End_Pad         ;End now if already required length
