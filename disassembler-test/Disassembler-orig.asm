...
; BASIC: ... AND (p = iPrecode(n)) ?
            XOR  A              ;Default precode for comparison = &00
            BIT  7,(IX+3)       ;Precode (index or extended)?
            JR   Z,@GotPrCode   ;No, so skip
            LD   A,&CB         ;Default precode for comparison = &CB
            BIT  6,(IX+3)       ;Precode = &ED?
            JR   Z,@GotPrCode   ;No, so skip
            LD   A,&ED         ;Yes, so precode for comparison = &ED
...
@Rel:       LD   DE,szDisTo     ;String = "  (to "
            ...
            DEC  D              ;Yes, so set hi byte to &FF
...
DisWrChar:
            PUSH AF
            AND  A,&7F         ;Mask off bit 7 (string start bit)
            CP   '-'            ;Code for "(HL)" ?
...
; If iDisTmp1 (the current index instruction opcode) is &DD or &FD,
...
@Char:      LD   A,(HL)         ;Get character from string
            AND  &7F           ;Mask off string start bit
...
;  6  ="r"    +0      No       No   (00)  "BCDEHL-A"          1  &38 (11)     000011
;  7  ="r2"   +0      No       No   (00)  "BCDEHL-A"          1  &07 (00)     000000
;  8  ="dd"   +0      No       No   (00)  "BCDEHLSP"          2  &30 (10)     000110
;  9  ="qq"   +0      No       No   (00)  "BCDEHLAF"          2  &30 (10)     000110
; 10  ="c"    +0      No       No   (00)  "NZZ NCC "          2  &18 (01)     000101
; 11  ="cc"   +0      No       No   (00)  "NZZ NCC POPEP M "  2  &38 (11)     000111
; 12  ="t"    +0      No       No   (00)  "0008101820283038"  2  &38 (11)     000111
; 13  ="b"    +0      No       No   (00)  "01234567"          1  &38 (11)     000011
...
DisOperandTable:
            .DB  &00,&00      ;0b000000 ;Operand  1 = ""
            .DB  &00,&10      ;0b010000 ;Operand  2 = "n"
            .DB  &00,&30      ;0b110000 ;Operand  3 = "(n)"
            .DB  &00,&18      ;0b011000 ;Operand  4 = "nn"
            .DB  &00,&38      ;0b111000 ;Operand  5 = "(nn)"
            .DB  &0E,&03      ;0b000011 ;Operand  6 = "r"
            .DB  &0E,&00      ;0b000000 ;Operand  7 = "r2"
            .DB  &0F,&06      ;0b000110 ;Operand  8 = "dd"
            .DB  &10,&06      ;0b000110 ;Operand  9 = "qq"
            .DB  &11,&05      ;0b000101 ;Operand 10 = "c"
            .DB  &12,&07      ;0b000111 ;Operand 11 = "cc"
            .DB  &13,&07      ;0b000111 ;Operand 12 = "t"
            .DB  &14,&03      ;0b000011 ;Operand 13 = "b"
...
DisConTab:  .DB  &40           ;xZxxxxxx   NZ,        Z=0,  Not Zero
            .DB  &01           ;xxxxxxxC   NC,        C=0,  No Carry
            .DB  &04           ;xxxxxxxC   PO,        P=0,  Parity Odd
            .DB  &80           ;xxxxxxxC   PO,        S=0,  Positive
...
iDisIndex:  .DB  &00           ;Index instruction opcode
iDisOpStr:  .DB  &00           ;Operation string number
iDisOp1Str: .DB  &00           ;Operand 1 string number
iDisOpcode: .DB  &00           ;Primary instruction opcode
iDisImmed:  .DW  &0000         ;Immediate value
